...
return view.extend({
	...
	render(data) {
		...
		function makeIntervalOptions(list) {
			...
			list.value(60,  '1 '  + _('minute'));
			list.value(120, '2 '  + _('minute'));
			list.value(300, '5 '  + _('minute'));
			list.value(600, '10 ' + _('minute'));
		}
		...
		s.addModalOptions = (s, section_id, ev) => {
			...
			if(this.currentAppMode !== '2') {
				...
				o.value(60,   '1 ' + _('minute'));
				o.value(120,  '2 ' + _('minute'));
				o.value(300,  '5 ' + _('minute'));
				o.value(600,  '10 ' + _('minute'));
				o.value(1800, '30 ' + _('minute'));
